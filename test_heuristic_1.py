...
def process_task(task):
    ...
    _, Q0_, _ = sampling_from_dsq(Q, n, s)
    _, Q1_, _ = sampling_from_dsq(Q, n, s)
    ...
    A = A1.stack(A2)
    A = A.change_ring(QQ) # fast rank computation
...
if __name__ == '__main__':
    ...
    parser.add_argument('--n', type=int, default=25, help='Dimension of the lattice')
